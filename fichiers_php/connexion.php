...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($erreur)) {
        ...
        if ($connecte) {
            /*  refuse la connexion si compte bloque. */
            if ($utilisateurTrouve['bloque'] ?? false) {
                ...
                if      ($_SESSION["role"] == "client")         header("Location: ../fichiers_php/accueil.php");
                elseif  ($_SESSION["role"] == "cuisinier")      header("Location: ../fichiers_php/commandes.php");
                elseif  ($_SESSION["role"] == "administrateur") header("Location: ../fichiers_php/administrateur.php");
                elseif  ($_SESSION["role"] == "livreur")        header("Location: ../fichiers_php/livraison.php");
                exit();
            }
        } else {
...
<main>
    <form action="../fichiers_php/connexion.php" method="POST" onsubmit="return verificationConnexion()">
        <fieldset>
            ...
            <a class="lien" href="../fichiers_php/mdpoublie.php">Mot de passe oublié ?</a>
            <br />
