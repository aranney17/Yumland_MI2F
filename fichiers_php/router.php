...
// Chemin demande (sans les parametres ?...)
...
// 2. Bloquer tout fichier .json, .log ou getapikey.php
//    ou qu'il se trouve (defense en profondeur)
...
// 3. Pour tout le reste : laisser le serveur servir normalement
//    (return false = "sers le fichier demande comme d'habitude")
$fichier = __DIR__ . $uri;
